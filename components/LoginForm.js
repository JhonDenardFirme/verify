    ...
    <div className='w-full h-[100vh] flex flex-row '>
      ...
      <div className='w-[50%] h-[100vh] black-gradient flex justify-center items-center overflow-y-auto'>
        <div className='flex flex-col w-full h-full justify-center items-center px-16 mt-16'>
          <h2 className='text-5xl text-center font-bold mb-2 mt-16'>Log In</h2>
          <p className='text-sm text-center font-light text-neutral-300'>Welcome back! Please enter your credentials.</p>
          ...
          <form className='w-full flex flex-col gap-6 justify-center items-center mt-8 p-8' action={formAction}>
            ...
            {
            formState && formState.error && Object.keys(formState.error || {}).length > 0 && (
                <div className='w-full flex flex-col gap-2'>
                {Object.keys(formState.error || {}).map((errorKey) => (
                    <div key={errorKey} className='bg-red-950 border-[1px] border-red-600 rounded-lg py-1 text-xs text-center w-full'>
            ...
            <div className='w-full flex flex-row justify-center items-center gap-2 mb-16'>
                <p className='text-xs font-medium text-white '>Don&apos;t have an account?</p>
                <Link href={'/auth/signup'} className='text-xs font-medium text-[#2dc1d6]'> Sign Up</Link>
            </div>
